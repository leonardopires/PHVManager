<%@ Page Language="vb" AutoEventWireup="false" Codebehind="receitas.aspx.vb" Inherits="afabre.receitas" %>
...
<HTML>
	...
	<body bottomMargin="0" bgColor="gainsboro" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<H1>
				<!-- ImageReady Slices (cabecalho.psd) --> Receitas</H1>
			<P></P>
						...
						<P>
							<asp:datalist id="lstNoticias" runat="server" Width="420px">
								...
								<AlternatingItemTemplate>
									...
									<asp:HyperLink id=lnkNoticiasAlt runat="server" NavigateUrl='<%# afabre.g.getroot(me.page) & "/res/layout.aspx?url=" & afabre.g.getroot(me.page) + "/res/gettexto.aspx?id=" + system.convert.tostring(DataBinder.Eval(Container.DataItem, "id_texto")) %>' CssClass="lstNoticiasAlt" Text="">
										<%# DataBinder.Eval(Container.DataItem, "titulo") %>
									</asp:HyperLink>
								</AlternatingItemTemplate>
							</asp:datalist></P>
