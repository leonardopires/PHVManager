...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim a As New SqlClient.SqlDataAdapter("select cast(t.titulo as char(1024)) as titulo, t.id_texto from texto t inner join area a on t.id_area = a.id_area where a.nomept = @area order by titulo desc", g.cn)
