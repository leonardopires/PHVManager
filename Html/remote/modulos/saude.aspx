<%@ Page Language="vb" validateRequest="false" AutoEventWireup="false" Codebehind="saude.aspx.vb" Inherits="remote.saude1" smartNavigation="False" aspCompat="True" culture="pt-BR" enableViewStateMac="True" %>
...
<asp:Button id="Button1" runat="server" Font-Size="8pt" Font-Bold="True" ForeColor="White" BackColor="#336666"
				...
				<TR>
					<TD style="PADDING-RIGHT: 3px; PADDING-LEFT: 20px; PADDING-BOTTOM: 5px; WIDTH: 1041px; PADDING-TOP: 5px; HEIGHT: 16px"
						bgColor="darkgray" colSpan="4"><asp:label id="Label3" runat="server" ForeColor="White" Font-Bold="True" Font-Size="8pt">Gerenciador de Dicas de Saúde</asp:label></TD>
				</TR>
				<TR>
