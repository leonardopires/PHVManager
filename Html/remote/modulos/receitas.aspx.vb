...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If g.logged Then
            ...
            a.SelectCommand.Parameters.Add("@area", "Receitas")

            g.ds.Clear()

            'testa se o usuário tem acesso ao modulo "Receitas"
			...
			lstAlterna.Items.FindByValue("receitas").Selected = True
...
#Region "Subrotinas de DB"
    ...
    Public Sub insertNoticia()
		...
		b.SelectCommand.Parameters.Add("@area", "Receitas")
