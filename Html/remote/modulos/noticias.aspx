<%@ Page Language="vb" validateRequest="false" AutoEventWireup="false" Codebehind="noticias.aspx.vb" Inherits="remote.noticias1" smartNavigation="False" aspCompat="True" culture="pt-BR" enableViewStateMac="True" %>
...
<asp:Label id="lblAlterna" runat="server" ForeColor="White" Font-Bold="True" Font-Size="8pt">Alternar para: </asp:Label>
<asp:DropDownList id="lstAlterna" runat="server" ForeColor="White" Font-Bold="True" Font-Size="8pt"
								BackColor="#336666" DataValueField="url" DataTextField="nome"></asp:DropDownList>
<asp:Button id="Button1" runat="server" ForeColor="White" Font-Bold="True" Font-Size="8pt" BackColor="#336666"
				...
				<TR>
					<TD style="PADDING-RIGHT: 3px; PADDING-LEFT: 20px; PADDING-BOTTOM: 5px; WIDTH: 1041px; PADDING-TOP: 5px; HEIGHT: 16px"
						bgColor="darkgray" colSpan="4"><asp:label id="Label3" runat="server" ForeColor="White" Font-Bold="True" Font-Size="8pt">Gerenciador de Notícias</asp:label></TD>
				</TR>
				<TR>
					...
					<td style="WIDTH: 191px; HEIGHT: 176px" bgColor="gainsboro"><asp:panel id="Panel1" runat="server" Width="164px" Height="160px">
							<asp:Label id="lblImagem" runat="server" Font-Bold="True" Font-Size="8pt">Escolha a foto a ser enviada:</asp:Label>
							<BR>
							<IFRAME 
